...
const topics = [
  ...
  },
  {
    ...
    speakers: [
      "Veneno Technologies株式会社 / 岩城 杏奈 主任研究員",
      "宮城大学 食産業学群 / 日渡 祐二 教授",
      "北里大学 海洋生命科学部 / 池田 大介 准教授",
      "フォーティエンスコンサルティング株式会社 / 原 誠 マネージングディレクター",
      "岐阜大学 糖鎖生命コア研究所 / 鎌足雄司 助教",
...
const speakerProfiles = [
  {
    name: "とかしき なおみ",
    organization: "衆議院議員(自由民主党)",
    role: "",
    summary: "渡嘉敷奈緒美 自民党 衆議院議員 大阪7区（吹田市・摂津市）薬剤師 資生堂に勤務。休職中に早大ビジネススクール卒業。「ビジネスと政治の架け橋」を信条に、在職立候補し杉並区議に。厚労委員長・厚労副大臣・環境副大臣・自民党厚労部会長・環境部会長など歴任。厚労と環境が専門。国政に復帰して5期目。",
    photo: "./assets/speakers/tokashiki-naomi.jpg",
    photoPosition: "50% 26%",
    photoScale: 1.02,
    logo: ""
  },
  ...
  },
  {
    ...
    role: "主任研究員",
    summary: "大学院修士課程を修了後、ライフサイエンス系の学術・診断薬開発を経てVeneno Technologiesに参画。\n\n現職では、当社独自のプラットフォーム技術を用いたジスルフィドリッチペプチドの研究開発、社会実装に取り組んでいる。",
    photo: "./assets/speakers/iwaki-anna.jpg",
    photoPosition: "50% 22%",
    photoScale: 1.02,
...
const agenda = [
  { time: "13:00 - 13:10", title: "オープニング", description: "日本細胞農業協会 / 小池 樹音" },
  { time: "13:10 - 14:15", title: "日本の企業・アカデミアのアップデート", description: "インテグリカルチャー 株式会社 / 羽生 雄毅 CEO\nインテグリカルチャー 株式会社 / 安竹 良礼 事業企画部\n株式会社オルガノイドファーム / 山木 多恵子 CEO\nImpacFat Pte. Ltd. / 髙木 安那 事業運営・リサーチアソシエイト\nCircular Cell Culture 株式会社 / 大友 春輝 CEO\n大阪大学工学研究科 / 松崎 典弥 教授" },
  { time: "14:15 - 14:20", title: "ご挨拶", description: "とかしき なおみ 衆議院議員(自由民主党)" },
  { time: "14:20 - 14:45", title: "休憩;  細胞農業・代替タンパク質・フードテックに取り組む10の企業・団体がブース出展しております", description: "" },
  { time: "14:45 - 15:45", title: "生研支援センター スタートアップ総合支援プログラム(SBIR支援) による、細胞農業の社会実装取り組み", description: "生研支援センター スタートアップ総合支援プログラム（SBIR支援）採択企業や大学による最先端研究を紹介いたします。\n\nVeneno Technologies株式会社 / 岩城 杏奈 主任研究員\n宮城大学 食産業学群 / 日渡 祐二 教授\n北里大学 海洋生命科学部 / 池田 大介 准教授\n岐阜大学 糖鎖生命コア研究所 / 鎌足 雄司 助教\nフォーティエンスコンサルティング株式会社 / 原 誠 マネージングディレクター\n日本細胞農業協会. 東京大学 / 岡田 健成" },
  { time: "15:45 - 16:15", title: "休憩;  細胞農業・代替タンパク質・フードテックに取り組む10の企業・団体がブース出展しております", description: "" },
  { time: "16:15 - 16:55", title: "細胞性食品の安全性評価と法規制", description: "西村あさひ法律事務所・外国法共同事業 アグリ・フードプラクティスグループ / 片桐 秀樹 弁護士\n国立医薬品食品衛生研究所 安全性生物試験研究センター / 北嶋 聡 シニアフェロー\n日本細胞農業協会. 東京大学 / 岡田健成（司会）" },
  { time: "16:55 - 17:35", title: "社会的受容から見る細胞農業の「売り方」", description: "味の素株式会社 グリーン事業推進部 / 降籏 泰史 企画グループ長\n東京科学大学 未来社会創成研究院 / 日比野 愛子 教授\n株式会社メロス / 小倉 千沙 CEO\n日本細胞農業協会 / 松原春佳（司会）" },
  { time: "17:35 - 18:05", title: "休憩;  細胞農業・代替タンパク質・フードテックに取り組む10の企業・団体がブース出展しております", description: "" },
  { time: "18:05 - 18:55", title: "代替タンパク質エコシステムの進化が加速させる食の未来", description: "アサヒグループジャパン株式会社FCH部 Likemilk / 畠 徳望博 シニアマネージャー\nファーメランタ株式会社 / 柊崎 庄吾 CEO\n株式会社麹ラボ / 萩原 大祐 CEO\n株式会社UnlocX / 田中 宏隆 CEO" },
  { time: "18:55 - 19:00", title: "クロージング", description: "" },
  { time: "19:00 - 20:30", title: "ネットワーキング", description: "" }
];
  ...
  container.innerHTML = agenda.map((item) => `
    <article class="agenda-item">
      ...
      <div class="agenda-main">
        <h3>${formatAgendaTitle(item.title)}</h3>
...
function formatAgendaTitle(title) {
  if (!title.includes(";")) return title;
  const [main, ...rest] = title.split(";");
  return `${main}; <span class="agenda-title-note">${rest.join(";").trim()}</span>`;
}
