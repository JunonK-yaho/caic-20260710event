...
const agenda = [
  ...
  { time: "14:45 - 15:35", title: "生研支援センター スタートアップ総合支援プログラム(SBIR支援) による、細胞農業の社会実装取り組み", description: "生研支援センター スタートアップ総合支援プログラム（SBIR支援）採択企業や大学による最先端研究を紹介いたします。\n\n北里大学 海洋生命科学部 / 池田 大介 准教授\nVeneno Technologies株式会社 / 木村忠史 取締役\n岐阜大学 科学研究基盤センター / 鎌足雄司 助教授\n日本細胞農業協会. 東京大学 / 岡田健成" },
  { time: "15:35 - 16:05", title: "休憩", description: "" },
  { time: "16:05 - 16:45", title: "細胞性食品の安全性評価と法規制", description: "西村あさひ法律事務所・外国法共同事業 アグリ・フードプラクティスグループ / 片桐 秀樹 弁護士\n国立医薬品食品衛生研究所 安全性生物試験研究センター 安全性予測評価部 / 北嶋 聡 シニアフェロー\n日本細胞農業協会. 東京大学 / 岡田健成（司会）" },
